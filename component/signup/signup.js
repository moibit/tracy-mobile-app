                    ...
                    <View style={{flex: 1 }}>
                        <View style={{ margin: 10, marginTop: '20%', textAlign: 'center' }}>
                            ...
                            <View style={{ marginTop: '8%' }}>
                                ...
                                <Text style={{ fontSize: 20, textAlign: 'center' }}>Signup to Tracy</Text>
                        ...
                        <Text style={{ textAlign: 'center', color: appColor.color, fontSize: 12 }}>Already Have an Account?<Text style={{ color: "#000" }} onPress={() => this.props.navigation.navigate("Login")}> Click here</Text></Text>
                    </View>
                </ScrollView>
